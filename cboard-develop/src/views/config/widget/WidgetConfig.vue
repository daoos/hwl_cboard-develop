                  ...
                  <div class="el-form-item">
                    ...
                    <div class="el-form-item__content">
                      <ul class="widget-type-list">
                        <li v-for="(type, index) in widgetTypes" :key="index"
                          @click.prevent="handleTypeClick(type, index)">
                          <el-popover
                            placement="bottom"
                            trigger="hover">
                            <div>
...
export default {
  ...
  data () {
    return {
      ...
      widgetTypes: [
        {
          name: this.$t('CONFIG.WIDGET.TABLE'),
          value: 'table',
          class: 'cTable',
        ...
        {
          name: this.$t('CONFIG.WIDGET.LINE_BAR'),
          value: 'line',
          class: 'cLine',
        ...
        {
          name: this.$t('CONFIG.WIDGET.CONTRAST'),
          value: 'contrast',
          class: 'cContrast',
          row: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE'),
        ...
        {
          name: this.$t('CONFIG.WIDGET.SCATTER'),
          value: 'scatter',
          class: 'cScatter',
          row: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE'),
          column: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_0_MORE'),
        ...
        {
          name: this.$t('CONFIG.WIDGET.FUNNEL'),
          value: 'funnel',
          class: 'cFunnel',
          row: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_0_MORE'),
          column: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_0'),
        ...
        {
          name: this.$t('CONFIG.WIDGET.SANKEY'),
          value: 'sankey',
          class: 'cSankey',
          row: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE'),
          column: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_0_MORE'),
        ...
        {
          name: this.$t('CONFIG.WIDGET.RADAR'),
          value: 'radar',
          class: 'cRadar',
          row: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE'),
          column: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_0_MORE'),
        ...
        {
          name: this.$t('CONFIG.WIDGET.GAUGE'),
          value: 'gauge',
          class: 'cGauge',
          row: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_0'),
          column: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_0'),
        ...
        {
          name: this.$t('CONFIG.WIDGET.WORD_CLOUD'),
          value: 'wordCloud',
          class: 'cWordCloud',
          row: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE'),
          column: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_0'),
        ...
        {
          name: this.$t('CONFIG.WIDGET.TREE_MAP'),
          value: 'treeMap',
          class: 'cTreeMap',
          row: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE'),
          column: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_0'),
        ...
        {
          name: this.$t('CONFIG.WIDGET.HEAT_MAP_CALENDER'),
        ...
        {
          name: this.$t('CONFIG.WIDGET.HEAT_MAP_TABLE'),
          value: 'heatMapTable',
          class: 'cHeatMapTable',
          row: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE'),
        ...
        {
          name: this.$t('CONFIG.WIDGET.LIQUID_FILL'),
          value: 'liquidFill',
          class: 'cLiquidFill',
          row: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_0'),
          column: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_0'),
        ...
        {
          name: this.$t('CONFIG.WIDGET.AREA_MAP'),
          value: 'areaMap',
          class: 'cAreaMap',
          row: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE'),
          column: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_0_MORE'),
        ...
        {
          name: this.$t('CONFIG.WIDGET.CHINA_MAP'),
          value: 'chinaMap',
          class: 'cChinaMap',
          row: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE'),
          column: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_0_MORE'),
        ...
        {
          name: this.$t('CONFIG.WIDGET.CHINA_MAP_BMAP'),
          value: 'chinaMapBmap',
          class: 'cChinaMapBmap',
          row: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_1_MORE'),
          column: this.$t('CONFIG.WIDGET.TIPS_DIM_NUM_0_MORE'),
        ...
        {
          name: this.$t('CONFIG.WIDGET.RELATION'),
          value: 'relation',
          class: 'cRelation',
